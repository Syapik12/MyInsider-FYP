        ...
        <div class="container">
          ...
          <div class="place-details">
            <div class="place-title">
              <h1 id="place-title">Beruas Museum</h1>
              <div class="row">
                  <div>
                      <!-- Dynamic Star Rating -->
                      <?php
                  ...
                  <div>
                        <p class="place-location">Location: Beruas, Perak, Malaysia</p>
                  </div>
              </div>
            </div>

              <div class="gallery" id="place-gallery">
                <img src="./lib/beruas1.jpg" class="gallery-img-1">
                <img src="./lib/beruas2.jpg">
                <img src="./lib/beruas3.jpg">
                <img src="./lib/beruas4.jpg">
                <img src="./lib/beruas5.jpg">
              </div>
              <div class="description">
                  <h2>Beruas Museum Preserving Ganga Negara's History</h2>
              </div>
              <hr class="line">
              <ul class="details-list">
                  <li><i class="fa-solid fa-archway"></i>Historical Significance
                      <span>History of the lost kingdom of Ganga Negara and Beruas, offering visitors a rich glimpse into their cultural legacy.</span>
                  </li>
                  <li><i class="fa-solid fa-l"></i>Adaptive Repurposing
                      <span>A former courthouse, combining historical architecture with modern museum functionality.</span>
                  </li>
                  <li><i class="fa-solid fa-trowel-bricks"></i>Beruas Historical Survey Project
                      <span>The museum's 1995 inception stems from the 1991 Beruas Historical Survey Project, emphasizing scholarly research.</span>
                  </li>
              ...
              <p class="home-desc">Welcome to the Beruas Museum, a captivating destination nestled in the heart of Beruas, Manjung District, Perak, 
                Malaysia. Immerse yourself in the rich history and cultural legacy of the lost kingdom of Ganga Negara and Beruas as you explore the 
                treasures housed within this remarkable institution.
                <br><br>
                The Beruas Museum, officially known as Muzium Beruas, traces its origins to a pivotal historical study conducted in 1991 by the Beruas 
                Historical Survey Project. Following extensive efforts, the museum building was officially handed over to the Perak State Government in 1995, 
                paving the way for its grand opening in July of the same year.
                <br><br>
                Housed within the walls of a former courthouse, the museum's architecture itself tells a tale of the region's past, providing a fitting backdrop 
                for the fascinating exhibits within.
                <br><br>
                Step into the museum, and you'll find yourself transported back in time as you encounter a curated collection of artifacts and historical gems. 
                The exhibitions showcase the glory of the ancient government of Gangga Negara and Beruas, offering visitors a glimpse into the bygone era through
                 illustration maps, notes, and over 300 meticulously preserved artifacts from the old kingdom.
              </p>
              ...
              <div class="map-container">
                ...
                <b>Beruas, Perak, Malaysia</b>
                <p>Mangosteen Town, Ancient Kingdom.</p>
              </div>
...
function initMapNoCard() {
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      var placeLatLng = {
        lat: perakMarkers[10].lat,
        lng: perakMarkers[10].lng,
      };
