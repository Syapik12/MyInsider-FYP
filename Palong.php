        ...
        <div class="container">
          ...
          <div class="place-details">
            <div class="place-title">
              <h1 id="place-title">Palong Tin Museum</h1>
              <div class="row">
                  <div>
                      <!-- Dynamic Star Rating -->
                      <?php
              ...
              <div class="gallery" id="place-gallery">
                <img src="./lib/Palong1.jpg" class="gallery-img-1">
                <img src="./lib/Palong2.jpg">
                <img src="./lib/Palong3.jpg">
                <img src="./lib/Palong4.jpg">
                <img src="./lib/Palong5.jpg">
              </div>
              <div class="description">
                  <h2>Palong Tin Museum: Malaysia's mining history and Kinta Valley activities.</h2>
              </div>
              <hr class="line">
              <ul class="details-list">
                  <li><i class="fa-solid fa-archway"></i>Interactive Displays
                      <span>Offering hands-on exploration of Malaysia's mining history through simulations and models.</span>
                  </li>
                  <li><i class="fa-solid fa-l"></i>Virtual Mine Tour
                      <span>Immerse in a virtual mine tour, navigating tunnels, exploring the mining process, gaining insights into challenges.</span>
                  </li>
                  <li><i class="fa-solid fa-trowel-bricks"></i>Historical Artefacts and Memorabilia
                      <span>Showcasing vintage tools, equipment, documents, and personal items for a tangible connection to mining heritage.</span>
                  </li>
                  <li><i class="fa-solid fa-image"></i>Educational Workshops
                      <span>Exploring traditional and modern mining methods, fostering technological appreciation.</span>
                  </li>
              </ul>

              <hr class="line">

              <p class="home-desc">Welcome to the Palong Tin Museum, a captivating destination nestled in the heart of Ipoh, Perak, Malaysia! 
                Immerse yourself in the rich tapestry of Malaysia's mining history as you embark on a journey through the exhibits thoughtfully curated at this museum.
                <br><br>
                History unfolds before your eyes as the Palong Tin Museum emerges from a visionary collaboration between the Kinta Riverfront Hotel and Suites, 
                the Ipoh City Council, and the Perak Water and Drainage Department. This dynamic partnership not only brought the museum to life but also played 
                a pivotal role in enhancing the scenic beauty of the Kinta River side landscape, creating an inviting atmosphere for exploration.
                <br><br>
                As you step into the museum, prepare to be transported back in time to the era of Kinta Valley tin mining activities. The carefully curated exhibitions 
                provide a fascinating insight into Malaysia's mining legacy, offering a comprehensive exploration of mining methods, historical milestones, 
                and the intricate details that shaped the region.
                <br><br>
                Discover the evolution of mining techniques, marvel at the tools that once echoed through the valleys, and gain a deeper appreciation for the industry 
                that left an indelible mark on the landscape. The Palong Tin Museum serves as a beacon, preserving and narrating the stories of the miners who toiled in 
                pursuit of precious tin.
              </p>
...
function initMapNoCard() {
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      var placeLatLng = {
        lat: perakMarkers[13].lat,
        lng: perakMarkers[13].lng,
      };
