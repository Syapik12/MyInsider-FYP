        ...
        <div class="container">
          ...
          <div class="place-details">
            <div class="place-title">
              <h1 id="place-title">Sultan Azlan Shah Gallery</h1>
              <div class="row">
                  <div>
                      <!-- Dynamic Star Rating -->
                      <?php
              ...
              <div class="gallery" id="place-gallery">
                <img src="./lib/galerisas1.jpg" class="gallery-img-1">
                <img src="./lib/galerisas2.jpg">
                <img src="./lib/galerisas3.jpg">
                <img src="./lib/galerisas4.jpg">
                <img src="./lib/galerisas5.jpg">
              </div>
              <div class="description">
                  <h2>Sultan Azlan Shah Gallery, Royal History and Achievements</h2>
              </div>
              <hr class="line">
              <ul class="details-list">
                  <li><i class="fa-solid fa-archway"></i>Historical Significance and Renovation
                      <span>Inaugurated in 2003 by Sultan Azlan Shah, housed in renovated Istana Ulu.</span>
                  </li>
                  <li><i class="fa-solid fa-l"></i>Architectural Blend
                      <span>Colonial, Acehnese, Indian influences; international materials with local elements.</span>
                  </li>
                  <li><i class="fa-solid fa-trowel-bricks"></i>Thematic Exhibits
                      <span>Comprehensive insight into Sultan Azlan Shah's multifaceted life.</span>
                  </li>
                  <li><i class="fa-solid fa-image"></i>Diverse Collections
                      <span>Cultural, historical, and personal facets of Sultan's life.</span>
                  </li>
              </ul>

              <hr class="line">

              <p class="home-desc">The Galeri Sultan Azlan Shah, inaugurated by DYMM Paduka Seri Sultan Perak, Sultan Azlan Muhibbuddin Shah on December 9, 2003, 
                is a beautifully restored gallery located within the historic Istana Ulu. Originally built in 1898 and completed in 1903, 
                Istana Ulu served as the residence for three former Sultans of Perak. Today, it stands as a magnificent gallery, 
                documenting the life journey of DYMM Sultan Azlan Shah, the 34th Sultan, Yang Dipertuan, and Raja Pemerintah Negeri Perak,
                 as well as the 9th Yang Dipertuan Agong.
              
              <br><br>
            
              The gallery showcases the architectural grandeur influenced by both colonial and local styles, 
              featuring a distinctive Aceh-inspired pyramid roof and Indian-influenced domes on its towers. 
              Imported materials, such as French roofing and Italian tiles, blend seamlessly with local elements like cengal wood frames and meranti wood carvings.

              <br><br>

              Divided into thematic sections, the exhibits present a systematic portrayal of DYMM Sultan Azlan Shah's personal life and achievements, 
              including his royal lineage, family, schooling, legal career, coronation as the 34th Sultan of Perak, 
              and tenure as the 9th Yang Dipertuan Agong. The gallery also highlights his involvement in sports, 
              military service as a Royal Colonel, the Royal Engineer Regiment, the Silver Jubilee celebration, 
              state regalia, and an impressive collection of artifacts, including keris, cars, and memorabilia.

              <br><br>

              Recognized for its significance, the Galeri Sultan Azlan Shah has received several awards, 
              including the Tourism Award for Best Heritage Attraction at both the national and state levels, 
              underscoring its role in deepening public understanding and appreciation of the Constitutional Monarchy.
              </p>
...
function initMapNoCard() {
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      var placeLatLng = {
        lat: perakMarkers[1].lat,
        lng: perakMarkers[1].lng,
      };
