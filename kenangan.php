        ...
        <div class="container">
          ...
          <div class="place-details">
            <div class="place-title">
              <h1 id="place-title">Istana Kenangan</h1>
              <div class="row">
                  <div>
                      <!-- Dynamic Star Rating -->
                      <?php
                  ...
                  <div>
                        <p class="place-location">Location: Kuala Kangsar, Perak, Malaysia</p>
                  </div>
              </div>
            </div>

              <div class="gallery" id="place-gallery">
                <img src="./lib/kenangan1.jpg" class="gallery-img-1">
                <img src="./lib/kenangan2.jpg">
                <img src="./lib/kenangan3.jpg">
                <img src="./lib/kenangan4.jpg">
                <img src="./lib/kenangan5.jpg">
              </div>
              <div class="description">
                  <h2>Istana Kenangan: Perak's Regal Heritage, Home to Perak Royal Museum.</h2>
              </div>
              <hr class="line">
              <ul class="details-list">
                  <li><i class="fa-solid fa-archway"></i>Architectural Design
                      <span>Design harmonizes traditional Malay and colonial influences, featuring two stories with cultural aesthetics of the early 20th century.</span>
                  </li>
                  <li><i class="fa-solid fa-l"></i>Construction by Malay Carpenter
                      <span>Constructed in 1926 by Malay carpenter Enci Sepian and sons, Istana Kenangan reflects skilled Malay craftsmanship.</span>
                  </li>
                  <li><i class="fa-solid fa-trowel-bricks"></i>Original Wooden Royal Office
                      <span>Istana Kenangan's ground floor, once an office with wooden flooring, reflects tradition; now, marble signifies evolution.</span>
                  </li>
                  <li><i class="fa-solid fa-image"></i>Dual Functionality as Reception Venue
                      <span>Istana Kenangan, a versatile palace, housed royalty and hosted events, adapting to changing royal dynamics seamlessly.</span>
                  </li>
              </ul>

              <hr class="line">

              <p class="home-desc">Welcome to the Istana Kenangan, a historical gem nestled in the heart of Kuala Kangsar, Malaysia. 
                Formerly known as the Remembrance Palace, this exquisite structure now houses the Perak Royal Museum, 
                offering visitors a captivating journey through time and Malaysian royalty.
                <br><br>
                History unfolds within the walls of Istana Kenangan, as it was meticulously crafted in 1926 for Sultan Iskandar Shah by the skilled hands of the 
                Malay carpenter Enci Sepian and his sons, Zainal Abidin and Ismail. Originally named the Valley Palace, 
                its significance is deeply rooted in the annals of Perak's regal past. Serving as the official residence from 1931 to 1933, 
                it later transitioned into a venue for royal receptions and accommodations for distinguished guests after the completion of Istana Iskandariah.
                <br><br>
                The architectural splendor of Istana Kenangan is a sight to behold. Standing proudly at two storeys, the top floor reveals the opulent bedchamber, 
                family bedrooms, and a dining hall, providing a glimpse into the lavish lifestyle of Perak's royalty. Meanwhile, the ground floor, 
                once the official royal office, boasts a rich history, with its original solid wood flooring eventually replaced by the timeless elegance of marble.
                <br><br>
                As you explore the museum, immerse yourself in the regal ambiance that once graced Istana Kenangan. 
                Marvel at the intricate craftsmanship that went into its construction, showcasing the talent and dedication of the craftsmen who brought 
                this palace to life. The museum's exhibits offer a window into the lives of Perak's royal family, with artifacts, photographs, 
                and historical displays that tell the story of a bygone era.
              </p>
              ...
              <div class="map-container">
                ...
                <b>Kuala Kangsar, Perak, Malaysia</b>
                <p>Royal town, historic, local products, tourism hub, accessible via transportation.</p>
              </div>
...
function initMapNoCard() {
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      var placeLatLng = {
        lat: perakMarkers[14].lat,
        lng: perakMarkers[14].lng,
      };
