...
<html>
    <head>
      <title>Leaning Tower of Teluk Intan</title>
        ...
        <div class="container">
          ...
          <div class="place-details">
            <div class="place-title">
              <h1 id="place-title">Leaning Tower of Teluk Intan</h1>
              <div class="row">
                  <div>
                      <!-- Dynamic Star Rating -->
                      <?php
                  ...
                  <div>
                        <p class="place-location">Location: Teluk Intan, Perak, Malaysia</p>
                  </div>
              </div>
            </div>

              <div class="gallery" id="place-gallery">
                <img src="./lib/condong1.jpg" class="gallery-img-1">
                <img src="./lib/condong2.jpg">
                <img src="./lib/condong3.jpg">
                <img src="./lib/condong4.jpg">
                <img src="./lib/condong5.jpg">
              </div>
              <div class="description">
                  <h2>Leaning Tower of Teluk Intan, Malaysia's Architectural Marvel</h2>
              </div>
              <hr class="line">
              <ul class="details-list">
                  <li><i class="fa-solid fa-archway"></i>Functional Design as a Water Storage Tower
                      <span>Originally a functional water storage.</span>
                  </li>
                  <li><i class="fa-solid fa-l"></i>Cultural Fusion in Architectural Influence
                      <span>Pagoda-style tower reflects Chinese heritage, showcasing Malaysia's multicultural essence.</span>
                  </li>
                  <li><i class="fa-solid fa-trowel-bricks"></i>Unusual Three-Storey Configuration
                      <span>Internal three-storey division adds surprise, showcasing clever use of space.</span>
                  </li>
                  <li><i class="fa-solid fa-image"></i>Historical Significance and Transformative Use
                      <span>Built 1885, repurposed by Japanese; national monument since Malaysia's independence, 1957.</span>
                  </li>
              </ul>

              <hr class="line">

              <p class="home-desc">The Leaning Tower of Teluk Intan, also known as Menara Condong Teluk Intan, stands as a unique landmark in the Hilir Perak District of Perak,
                 Malaysia. Constructed in 1885 by contractor Leong Choon Chong, the tower originally served the practical purposes of storing water for 
                 fire emergencies during the dry season and functioning as a timekeeping structure. 
                 This Malaysian counterpart to the Leaning Tower of Pisa rises 25 meters in height and appears as an eight-storey building from the outside, 
                 though internally it is divided into three storeys.
              
              <br><br>
            
              Influenced by Chinese architectural style, the pagoda-like structure reflects the predominant Chinese population in the town during its construction. 
              With 110 steps leading from the ground floor to the top, each storey stands at 5 meters in height. The third floor houses a steel water tank, 
              5 meters high and with a capacity of 18.36 cubic meters, designed to fulfill its original purpose.

              <br><br>

              The tower's distinctive lean is attributed to the soft ground upon which it was built and the weight of the water in the tank,
               causing a southwest-leaning tilt. Despite changing ownership during British and Japanese occupations, 
               the tower became an official national monument after Malaysia gained independence in 1957. Today, 
               it stands as a testament to historical significance and architectural charm.
              </p>
              ...
              <div class="map-container">
                ...
                <b>Teluk Intan, Perak, Malaysia</b>
                <p>District capital, historical town with Leaning Tower attraction.</p>
              </div>
...
function initMapNoCard() {
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      var placeLatLng = {
        lat: perakMarkers[5].lat,
        lng: perakMarkers[5].lng,
      };
