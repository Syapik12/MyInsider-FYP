        ...
        <div class="container">
          ...
          <div class="place-details">
            <div class="place-title">
              <h1 id="place-title">Gaharu Tea Valley</h1>
              <div class="row">
                  <div>
                      <!-- Dynamic Star Rating -->
                      <?php
              ...
              <div class="gallery" id="place-gallery">
                <img src="./lib/Gaharu1.jpg" class="gallery-img-1">
                <img src="./lib/Gaharu2.jpg">
                <img src="./lib/Gaharu3.jpg">
                <img src="./lib/Gaharu4.jpg">
                <img src="./lib/Gaharu5.jpg">
              </div>
              <div class="description">
                  <h2>Gaharu Tea Valley: A Sanctuary of Rare Aquilaria Trees Unveiled.</h2>
              </div>
              <hr class="line">
              <ul class="details-list">
                  <li><i class="fa-solid fa-archway"></i>Rare and Endangered Aquilaria spp Species
                      <span>Gaharu Tea Valley conserves 200,000 endangered Aquilaria spp trees, crucial for preserving this critically endangered species.</span>
                  </li>
                  <li><i class="fa-solid fa-l"></i>Agro-Tourism Experience
                      <span>Gaharu Tea Valley offers agro-tourism, letting visitors explore tea plantation, learn Aquilaria spp cultivation, and tea production.</span>
                  </li>
                  <li><i class="fa-solid fa-trowel-bricks"></i>Large Plantation Area
                      <span>Gaharu Tea Valley spans 120 hectares, offering an immersive experience as visitors wander through picturesque tree-lined landscapes.</span>
                  </li>
                  <li><i class="fa-solid fa-image"></i>Cultural Significance of Gaharu
                      <span>Culturally significant Agarwood site, blending conservation, agriculture, and history, enhancing visitor experience.</span>
                  </li>
              </ul>

              <hr class="line">

              <p class="home-desc">Welcome to the enchanting Gaharu Tea Valley, a captivating agro-tourism destination nestled in the heart of Gopeng, Kampar District, Perak, Malaysia. 
                Immerse yourself in a journey through time and nature as you explore the rich history and lush landscapes of this extraordinary tea plantation.
                <br><br>
                Since 2012, Gaharu Tea Valley has been welcoming visitors with open arms, inviting them to discover the secrets of its unique heritage and the 
                artistry of tea cultivation. The plantation stands as a testament to Malaysia's commitment to preserving its cultural and natural treasures.
                <br><br>
                Spanning over 120 hectares, Gaharu Tea Valley boasts a breathtaking landscape adorned with more than 200,000 trees of a special hybrid Aquilaria spp species. 
                This particular species holds significant ecological importance, as it is critically endangered in the wild. Known locally as Gaharu and internationally as 
                Agarwood, Aloes, or Eagleswood, these trees contribute to the lush greenery that blankets the plantation.
              </p>
...
function initMapNoCard() {
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      var placeLatLng = {
        lat: perakMarkers[16].lat,
        lng: perakMarkers[16].lng,
      };
